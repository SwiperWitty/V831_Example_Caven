...
# L_MIN,A_MIN,B_MIN,L_MAX,A_MAX,B_MAX # important !!!!
color = [(255, 0, 0),#red
        (0, 255,0),#green
        (0, 0,255)]#blue
flag = '1'
        ...
        if blobs :
            for i in blobs:
                ...
                if size > 2000 : 
                    ...
                    # img.draw_rectangle(x_start, y_start, x_end, y_end, 
                    #                     color=(int(git_color[0]), int(git_color[1]), int(git_color[2])), thickness=2) #将找到的颜色区域画出来
